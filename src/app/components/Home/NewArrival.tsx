			...
			<div className='grid grid-cols-1 md:grid-cols-4 gap-6'>
				<div className='bg-white shadow rounded overflow-hidden group'>
					<div className='relative'>
						<img
							src='https://yi-files.s3.eu-west-1.amazonaws.com/products/953000/953291/1611556-cover.jpg'
							alt='product 1'
							className='w-full'
						/>
						<div
				...
				<div className='bg-white shadow rounded overflow-hidden group'>
					<div className='relative'>
						<img
							src='https://yi-files.s3.eu-west-1.amazonaws.com/products/642000/642133/1112562-cover.jpg'
							alt='product 1'
							className='w-full'
						/>
						<div
